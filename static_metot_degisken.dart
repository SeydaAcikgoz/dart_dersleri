...
main(List<String> args) {
  ...
  print(Matematik.PI);//static değişkenlere sınıfı üzerinden erişilebilir
  Matematik.sinifAdiniSoyle(); //static metotlara sınıfı üzerinden erişilebilir
...
class Matematik {
  ...
  int birinciSayi = 0;
  int ikinciSayi = 0;
  static int toplamIslemSayisi = 0;//static olarak tanımlandığı için bütün toplama işlemlerini tutar.
