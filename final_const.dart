...
/*
  ...
  const tarih2 = DateTime.now();  hatalı
  */

  /*  
  final liste = [1, 2, 3];
  final liste2 = [1, 2, 3];
  liste==liste2 eşit değil
final listeye eleman eklenebilir 
  liste.add(4);
  liste2.add(8);

  liste = [5, 6]; hata 
  final liste tamamen değiştirlemez
  */
  ...
  const liste2 = [1, 2];
  const liste3 = [1, 2];
//const listeye eleman eklenemez
