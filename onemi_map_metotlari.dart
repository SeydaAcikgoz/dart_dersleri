main(List<String> args) {
  ...
  map.update('id_yeni', (value) => value * 3, ifAbsent: () => 100);//id_yeni diye bir alan varsa o değerin 3 katına eşitle eğer yoksa 100 e eşitle
  print(map);

  map.putIfAbsent("soyisim", () => "altunbilek");
  print(map);//soyisim keyi yoksa değerine altunbilek ata
}
